...
import "./Signup.css";
import botImg from "../assets/Toto.png";
...
function Signup() {
  ...
  async function uploadImage() {
    ...
    data.append("upload_preset", "ca1n8fh4"); //Restrict uploading images by anyone
    try {
      setUploadingImg(true);
      let res = await fetch(
        "https://api.cloudinary.com/v1_1/dqlyuq68h/image/upload",
        {
          method: "post",
          body: data,
        }
